  ...
  const fetchLocationData = useCallback(
    async (postcode) => {
      ...
      try {
        ...
        setMessage(
          createErrorMessage(
            result.message || "Could not find location data for this postcode"
          )
        );
        ...
        setMessage(
          createErrorMessage(
            "Failed to fetch location data. Please check your connection."
          )
        );
        setLocationData(null);
        return null;
