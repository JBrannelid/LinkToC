...
export const MemoizedListItemRenderer = React.memo(
  ...
  (prev, next) => {
    return (
      ...
      prev.item[prev.config?.labelField || "name"] ===
        next.item[next.config?.labelField || "name"] &&
      prev.item[prev.config?.secondaryField] ===
        next.item[next.config?.secondaryField] &&
