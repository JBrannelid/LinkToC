...
const Button = ({
  ...
  const typeStyles = {
    primary:
      "bg-primary text-white border border-white hover:border hover:border-gray focus:ring-primary focus:outline-none focus:ring-1 focus:ring-offset-2",
    secondary:
      "bg-white border border-primary hover:bg-gray-300 focus:ring-gray-300 focus:outline-none focus:ring-1 focus:ring-offset-2",
    danger:
      "bg-error-500 text-white hover:bg-error-600 focus:ring-error-400 focus:outline-none focus:ring-1 focus:ring-offset-2",
    warning:
      "bg-warning-300 text-gray-800 hover:bg-warning-400 focus:ring-warning-300 focus:outline-none focus:ring-1 focus:ring-offset-2",
