...
const WelcomeLayout = ({ children }) => {
  return (
    <>
      ...
      <div className="hidden lg:grid lg:grid-cols-6 lg:min-h-screen">
        <div className="lg:col-span-3 bg-gray-100 flex flex-col justify-center items-center px-8 py-12">
