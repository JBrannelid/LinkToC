                ...
                <form onSubmit={handleSubmit(onSubmit)} aria-labelledby="login-heading" noValidate className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-end mb-6">
                        <a href="/forgot-password" className="text-sm text-gray-400 hover:text-gray-500">
                            Forgot Your <span className="text-orange-300">Password</span> ?
                        </a>
                    </div>
                    ...
                    <div className="flex justify-center space-x-8">
                        ...
                        >
                            <Feather className="h-6 w-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            </Feather>
                        </button>
                        <button
                            type="button"
                            ...
                            className="p-2 rounded-full border border-gray-300 hover:bg-gray-50"
                        >
                            <FacebookIcon className="h-6 w-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            </FacebookIcon>
                        </button>
                        <button
                            type="button"
                            ...
                            className="p-2 rounded-full border border-gray-300 hover:bg-gray-50"
                        >
                            <LinkedinIcon className="h-6 w-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            </LinkedinIcon>
                        </button>
                    </div>
