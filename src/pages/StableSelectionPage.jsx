...
import CreateStableForm from "../components/forms/CreateStableForm";
import JoinStableForm from "../components/forms/JoinStableForm";
  ...
  const getConfirmationProps = () => {
    ...
    if (action === "delete") {
      return {
        ...
        iconBg: "bg-error-500",
        message:
          "This action cannot be undone. All data associated with this stable will be permanently deleted.",
      };
    } else if (action === "leave") {
      return {
